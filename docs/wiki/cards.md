...
| Baluarte | Reduz dano recebido |
| Toque Glacial | Lentidão em quem te ataca |
| Noite Vampírica | Cura ao matar mobs à noite |
| Forrageador+ | Colheitas rendem ainda mais |
...
| Eco | Habilidades têm chance de reativar |
| Último Suspiro | Explosão ao morrer |
| Momentum | +velocidade e dano progressivo em combate |
| Explorador Ascendente | Bônus lendário de Explorador |
| Minerador Ascendente | Bônus lendário de Minerador |
| Construtor Ascendente | Bônus lendário de Construtor |

> Catálogo configurável via `augments.yml`. Cartas com trade-off são propositais — são as que mudam a run.
